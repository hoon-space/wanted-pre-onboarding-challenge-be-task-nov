...
<center><img src="./Images/IP의_역할.png" width="300"></center>
...
<center><img src="./Images/OSI%207%20계층.png" width="300"></center>
...
<center><img src="./Images/OSI7_Box_in_Box.png" width="140"></center>

어떤 식으로 계층마다 식별가능한 정보를 담는가?
전달하는 데이터에 헤더를 추가하여 각 계층에서 식별할 수 있는 정보들을 덧씌워 전달한다. 마치 Box-in-Box 와 같은 형태로 되어있다.

<center><img src="./Images/packet-to-ethernetframe.png" width="300"></center>

<br/>

## 목적지 찾기: 주소 요소들은 어떻게 찾을까?

<center><img src="./Images/주소찾기.png" width="300"></center>
...
<center><img src="./Images/DNS-resolution.png" width="300"></center>
...
<center><img src="./Images/gateway.png" width="300"></center>

접속할 서버가 다른 네트워크에 있다면: Gateway에 던져놓고 맡긴다.

<center><img src="./Images/Networkend-to-end.png" width="300"></center>
...
- Latency: Network delay
    ...
    <center><img src="./Images/latency.png" width="300"></center>
...
- Jitter
    ...
    <center><img src="./Images/jitter.png" width="300"></center>
...
<center><img src="./Images/Switch_OSI.png" width="300"></center>
